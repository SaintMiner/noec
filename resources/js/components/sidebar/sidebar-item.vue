<template>
    <div class="sidebar-item mt-3" v-if="!item.subitems">
        <router-link class="btn btn-block text-left text-light p-3 font-weight-bold" :to="{name: item.routeName}">
